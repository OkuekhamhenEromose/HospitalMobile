...
const ReviewsStatIcon = ({ color }: { color: string }) => (
  <Svg width={20} height={20} viewBox="0 0 2048 2048">
    <Path
      fill={color}
      d="m448 768l-320 320V768H0V128h1664v640zm-64 256h1664v640h-128v320l-320-320H384z"
    />
  </Svg>
);
        ...
        <View style={styles.content}>
          ...
          <View style={styles.badgeRow}>
            ...
            <View style={[styles.badge, { backgroundColor: "#fef9ee" }]}>
              <Text style={[styles.badgeText, { color: C.star }]}>
                ⭐ Featured
              </Text>
            </View>
          </View>
          ...
          >
            {[
              ...
              <View
                key={i}
                style={[styles.aboutCard, { backgroundColor: card.bg }]}
              >
                <MaterialIcons
          ...
          {loadingPost ? (
            ...
            <View style={pw.card}>
              ...
              <View style={pw.imgWrap}>
                ...
                />
                {/* Category badge */}
                <View style={pw.catBadge}>
                  <Text style={pw.catBadgeTxt}>
                    {post.category?.name ?? "General Health"}
                  </Text>
                </View>
                {/* Gradient scrim */}
                {/* <View style={pw.imgScrim} /> */}
              </View>

              {/* ── Text body ── */}
              <View style={pw.body}>
                <Text style={pw.title} numberOfLines={2}>
                  {post.title}
                </Text>

                <Text style={pw.desc}>
                  {(post.description ?? post.short_description ?? "").length >
                  120
                ...
                {/* ── CTA row ── */}
                <View style={pw.ctaRow}>
                  <TouchableOpacity
                    style={pw.primaryBtn}
                    onPress={() => navigate("BlogPost")}
                    activeOpacity={0.85}
                  >
                    <MaterialIcons name="article" size={15} color={C.white} />
                    <Text style={pw.primaryBtnTxt}>Get More Details</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    activeOpacity={0.85}
                  >
                    <Text style={pw.outlineBtnTxt}>View All Blogs</Text>
                    <MaterialIcons
                      name="chevron-right"
                      size={16}
                      color={C.primary}
